...
<?php include "./humantrafficking/includes/headerMiddle.php"; ?>
<?php include "../bulldogcms/frontend/includes/headerEnd.php"; ?>

<!-- Page Content Index from CMS folder -->
<?php include "../bulldogcms/frontend/bdCalendar-content.php"; ?>
...
<?php include "./humantrafficking/includes/footerMiddle.php"; ?>
