...
while($row = mysqli_fetch_assoc($selectBodySettings)) {
    ...
    $GLOBAL['heroicImage1']      = $row['heroicImage1'];
    $GLOBAL['heroicImage2']      = $row['heroicImage2'];

    $GLOBAL['heroicHeader']      = $row['heroicHeader'];
    $GLOBAL['heroicHeader1']      = $row['heroicHeader1'];
    $GLOBAL['heroicHeader2']      = $row['heroicHeader2'];

    $GLOBAL['heroicText1']      = $row['heroicText1'];
    $GLOBAL['heroicText2']      = $row['heroicText2'];
    $GLOBAL['heroicText3']      = $row['heroicText3'];
}
